...
namespace ArcheAgeLogin.ArcheAge
{
    ...
    public class GameServerController
    {
        ...
        public static bool RegisterGameServer(byte id, string password, GameConnection con, short port, string ip)
        {
            ...
            {
                Logger.Trace("The server is not defined- {0}-，Please check", id);
                return false;
            }
            ...
            {
                Logger.Trace("World server- {0}- wrong password", id);
                return false;
            }
            ...
            Logger.Trace("World server - id：{0} - registered", id);
            return true;
        }
        ...
        public static void LoadAvailableGameServers()
        {
            ...
            Logger.Trace("From-- Servers.xml --load- {0} -Server", gameservers.Count);
        }
    }
