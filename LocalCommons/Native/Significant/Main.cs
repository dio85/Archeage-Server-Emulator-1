...
namespace LocalCommons.Native.Significant
{
    ...
    public class Main
    {
        ...
        public static void InitializeStruct(string[] args)
        {
            ...
            Logger.Section("The assembly started repair + finished by: cigarette cage");

            Version ver = Assembly.GetExecutingAssembly().GetName().Version;

            Logger.Trace("ArcheAge Emu - Verison {0}.{1}, Build {2}.{3}", ver.Major, ver.Minor, ver.Build, ver.Revision);
            ...
            Logger.Trace("If you want to stop the service please press directly Ctrl + C");
